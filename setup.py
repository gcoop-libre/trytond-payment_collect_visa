...
name = 'trytonar_payment_collect_visa'

download_url = 'https://github.com/gcoop-libre/trytond-payment_collect_visa/tree/%s.%s' % (
...
setup(name=name,
    ...
    author='gcoop-libre',
    url='https://github.com/gcoop-libre/trytond-payment_collect_visa',
    download_url=download_url,
    package_dir={'trytond.modules.payment_collect_visa': '.'},
    packages=[
        'trytond.modules.payment_collect_visa',
        'trytond.modules.payment_collect_visa.tests',
        ],
    package_data={
        'trytond.modules.payment_collect_visa': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    payment_collect_visa = trytond.modules.payment_collect_visa
    """,
    test_suite='tests',
